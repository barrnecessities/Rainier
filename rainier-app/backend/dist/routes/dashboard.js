...
exports.dashboardRouter.get("/", (req, res) => {
    ...
    const whoopMock = { recovery: 78, strain: 12, sleepPerformance: 84 };
    const readiness = (0, trainingPlanService_1.readinessFromWhoop)(whoopMock.recovery, whoopMock.strain, whoopMock.sleepPerformance);
    res.json({
        readiness,
        weeklyPlan: {
